...
As quantum computing becomes viable, applications must be examined. Neural network are a potentially useful application of quantum computing. Due to quantum computers simplicity, pure quantum neural networks are difficult to implement and test, but hybrid classical-quantum neural networks are viable.
